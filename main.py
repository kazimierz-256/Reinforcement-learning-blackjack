...
if __name__ == "__main__":
    ...
    episode_count_list = [10_000]
    print_status_every_n_episodes = 1_000
    # also known as gamma
    discount_factor = 1.0
    random_seed = 123
    ...
    for episode_count in episode_count_list:
        for probability_of_random_choice in probability_of_random_choice_list:
            ...
            player_instance = player.Player(strategy=player_fixed_strategy)
            dealer_win_count = 0
            player_win_count = 0
            player_win_history = []
            ...
            if show_plots_in_browser_tab:
                visualization.draw_figure(player_win_history, player_win_history_average, player_win_history_std)
